...
const menuItems = [
  ...
  { title: "Applications", url: "/onboarding-new", icon: Server },
  ...
  { title: "Onboarding", url: "/onboarding_nipun", icon: ClipboardPlus },
  // { title: "ONboarding Data", url: "/onboarding-data", icon: ClipboardPlus },
  { title: "Scans", url: "/SSL-TLS scans", icon: ScanLine },
  { title: "Assets Scans", url: "/PQC-Scans", icon: Computer },
